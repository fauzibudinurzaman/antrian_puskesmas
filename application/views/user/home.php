...
<body id="page-top">
  ...
  <header class="masthead bg-primary text-white text-center">
    <div class="container d-flex align-items-center flex-column">
      ...
      <?php } ?>
      <?php if(empty($this->session->userdata('id_pasien'))){ ?>
        <h4 class="masthead mb-0" style="margin-top: 10px !important;padding: 20px;">Selamat Datang di Puskesmas Mariuk. 
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-6 mb-5 mb-lg-0">
          ...
          <p class="lead mb-0">Dsn Mariuk Rt/Rw 01/01 
            <br>Des Mariuk kec Tambakdahan</p>
        </div>
        ...
        <div class="col-lg-6">
          ...
          <p class="lead mb-0">(+62)85524867552</p>
        </div>
  ...
  <section class="copyright py-4 text-center text-white">
    <div class="container">
      <small>&copy; Antrian Puskesmas Mariuk 2022 Made By Mustika Ainillah </small>
    </div>
  </section>
